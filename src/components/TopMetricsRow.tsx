...
const metrics = [
  { id: 'kemiskinan', title: 'Kemiskinan', value: '9,21%', change: '-0,35%', isPositive: true, period: 'vs Apr 2025', icon: Users, data: [9.6, 9.8, 9.3, 9.5, 9.25, 9.21] },
  { id: 'stunting', title: 'Stunting', value: '21,3%', change: '-0,6%', isPositive: true, period: 'vs Apr 2025', icon: UserPlus, data: [22.2, 21.5, 21.8, 21.1, 21.6, 21.3] },
  { id: 'tpt', title: 'TPT', value: '5,32%', change: '+0,18%', isPositive: false, period: 'vs Apr 2025', icon: Briefcase, data: [5.0, 5.3, 5.1, 5.4, 5.2, 5.32] },
  { id: 'ipm', title: 'IPM', value: '73,41', change: '+0,42', isPositive: true, period: 'vs Apr 2025', icon: TrendingUp, data: [72.5, 73.1, 72.8, 73.5, 73.2, 73.41] },
  { id: 'spbe', title: 'SPBE', value: '3,12', change: '+0,11', isPositive: true, period: 'vs Apr 2025', icon: MonitorSmartphone, data: [2.9, 3.1, 3.0, 3.2, 3.05, 3.12] },
  { id: 'iid', title: 'IID', value: '0,54', change: '+0,03', isPositive: true, period: 'vs Apr 2025', icon: Building2, data: [0.45, 0.51, 0.49, 0.55, 0.52, 0.54] },
  { id: 'inflasi', title: 'Inflasi', value: '2,84%', change: '+0,19%', isPositive: false, period: 'vs Apr 2025', icon: ShoppingCart, data: [2.5, 2.8, 2.6, 2.9, 2.7, 2.84] },
  { id: 'fiskal', title: 'Kinerja Fiskal', value: '73,6%', change: '+1,2%', isPositive: true, period: 'vs Apr 2025', icon: CircleDollarSign, data: [71, 73, 72, 74, 72.5, 73.6] },
];
